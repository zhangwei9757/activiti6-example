...
import com.example.dto.ModifyCronDTO;
import com.example.entity.JobEntity;
import com.example.service.DynamicJobService;
import com.example.service.JobEntityRepository;
        ...
        synchronized (log) {
            ...
            for (JobEntity job : jobService.loadJobs()) {
                ...
                if (job.getStatus().equals("OPEN")) {
                    Date date = scheduler.scheduleJob(jobDetail, jobService.getTrigger(job));
                } else {
